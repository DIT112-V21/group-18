package group18.app.cleaningApp;
...
public class MainActivity extends AppCompatActivity {
    private static final String TAG = "UVCleaningApp";
    ...
    private static final String SET_AUTO_CLEANING = "/smartcar/control/autoclean";
    ...
    void activateAutomaticCleaning(String actionDescription) {
        if (!isConnected) {
            final String notConnected = "Not connected (yet)";
            Log.e(TAG, notConnected);
            Toast.makeText(getApplicationContext(), notConnected, Toast.LENGTH_SHORT).show();
        ...
        Log.i(TAG, actionDescription);
        mMqttClient.publish(SET_AUTO_CLEANING, Integer.toString(1), QOS, null);
    }
    ...
    public void setAutoClean(View view){
        activateAutomaticCleaning("Activating Auto Cleaning");
    }
}